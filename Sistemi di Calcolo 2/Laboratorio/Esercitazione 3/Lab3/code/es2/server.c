...
void cleanup() {
     ...
     * **/
     ...
     sem_close(named_semaphore); //ESERCIZIO
     sem_unlink(SEMAPHORE_NAME); //ESERCIZIO
...
int main(int argc, char* argv[]) {
    ...
    named_semaphore = sem_open(SEMAPHORE_NAME, O_CREAT | O_EXCL, 0600, NUM_RESOURCES); //ESERCIZIO
